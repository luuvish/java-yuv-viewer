...
public class YuvViewer {
  ...
  long                stepSize  = 1;
  long                delay     = Math.round(1000.0/30.0);
  ...
  private JPanel initFilePanel() {
    ...
    ftFieldImgWidth.setValue(new Integer(720));
    ...
    sliderImgWidth = new JSlider(JSlider.HORIZONTAL, 1, 2560, 720);
    ...
    sliderImgWidth.setMajorTickSpacing(720);
    ...
    ftFieldImgHeight.setValue(new Integer(480));
    ...
    public void drop(DropTargetDropEvent de) {
      ...
      try {
        if (tr.isDataFlavorSupported(DataFlavor.javaFileListFlavor)) {
          ...
          java.util.List<File> list = (java.util.List<File>)
  ...
  private void openFile(File file) {
    ...
    case 0: format = YuvImage.Format.YUV_400; break;
    case 1: format = YuvImage.Format.YUV_420; break;
    case 2: format = YuvImage.Format.YUV_422; break;
    case 3: format = YuvImage.Format.YUV_224; break;
    case 4: format = YuvImage.Format.YUV_444; break;
    }
